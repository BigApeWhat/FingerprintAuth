...
public class FingerprintUiHelper extends FingerprintManager.AuthenticationCallback {
    ...
    public static class FingerprintUiHelperBuilder {
        ...
        public FingerprintUiHelper build(Context context, ImageView icon, TextView errorTextView,
                Callback callback) {
            return new FingerprintUiHelper(context, mFingerPrintManager, icon, errorTextView,
                    callback);
        }
    }
